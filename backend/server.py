...
from routes import auth_routes, property_routes, ai_routes, investment_routes, payment_routes, whatsapp_routes, user_routes, admin_routes, upload_routes, exit_resale_routes, supplier_routes
